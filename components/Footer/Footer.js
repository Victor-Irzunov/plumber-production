...
export default function Footer() {
	return (
		<footer
			className="footer footer-center bg-slate-200
			py-10 sd:px-10 xz:px-3 text-base-content rounded"
			id='contacts'
		>
			...
			<nav>
				<h5 className='mb-1 w-[60vw] font-semibold'>
					Для заказа услуги сантехника вы можете воспользоваться кнопкой «Оставить заявку» или "Заказать" на нашем сайте или воспользоваться одним из следующих способов:
				</h5>
				...
				<div className='mt-4'>
					<a href='tel:80290000000' className='btn text-xl'>
						+375 29 000-00-00
					</a>
				</div>
